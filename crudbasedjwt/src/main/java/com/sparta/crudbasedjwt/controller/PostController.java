...
public class PostController {
    ...
    @GetMapping("/list")
    public List<PostResponseDto> getPostList() {return postService.getPostList();}
    //선택 게시글 조회 (게시글의 id를 특정하여 받아온다)
    @GetMapping("/list/{id}")
    public PostResponseDto getPost(@PathVariable Long id) {return postService.getPost(id);}
    ...
    public ResponseEntity<StatusCodeDto> deletePost(@PathVariable Long id, HttpServletRequest request) {
